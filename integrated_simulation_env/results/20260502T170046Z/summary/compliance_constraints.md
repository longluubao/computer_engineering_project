...
|----------|--------------|----------------|-------------|------|
| attacks_aggregate_hmac | 894.83 | D2 | ≤ 5000 | PASS |
| attacks_aggregate_hybrid | 1429.19 | D2 | ≤ 5000 | PASS |
| attacks_aggregate_pqc | 1422.88 | D2 | ≤ 5000 | PASS |
| attacks_dos_flood_hmac | 926.12 | D2 | ≤ 5000 | PASS |
| attacks_dos_flood_hybrid | 2031.77 | D2 | ≤ 5000 | PASS |
| attacks_dos_flood_pqc | 2018.20 | D2 | ≤ 5000 | PASS |
| attacks_downgrade_hmac_hmac | 823.08 | D2 | ≤ 5000 | PASS |
| attacks_downgrade_hmac_hybrid | 1939.66 | D2 | ≤ 5000 | PASS |
| attacks_downgrade_hmac_pqc | 1193.49 | D2 | ≤ 5000 | PASS |
| attacks_freshness_rollback_hmac | 890.53 | D2 | ≤ 5000 | PASS |
| attacks_freshness_rollback_hybrid | 1203.01 | D2 | ≤ 5000 | PASS |
| attacks_freshness_rollback_pqc | 1206.36 | D2 | ≤ 5000 | PASS |
| attacks_harvest_now_hmac | 926.09 | D2 | ≤ 5000 | PASS |
| attacks_harvest_now_hybrid | 1299.88 | D2 | ≤ 5000 | PASS |
| attacks_harvest_now_pqc | 1878.78 | D2 | ≤ 5000 | PASS |
| attacks_mitm_key_confuse_hmac | 906.48 | D2 | ≤ 5000 | PASS |
| attacks_mitm_key_confuse_hybrid | 1381.17 | D2 | ≤ 5000 | PASS |
| attacks_mitm_key_confuse_pqc | 1986.74 | D2 | ≤ 5000 | PASS |
| attacks_replay_hmac | 907.09 | D2 | ≤ 5000 | PASS |
| attacks_replay_hybrid | 1199.49 | D2 | ≤ 5000 | PASS |
| attacks_replay_pqc | 1121.97 | D2 | ≤ 5000 | PASS |
| attacks_sig_fuzz_hmac | 903.21 | D2 | ≤ 5000 | PASS |
| attacks_sig_fuzz_hybrid | 1950.72 | D2 | ≤ 5000 | PASS |
| attacks_sig_fuzz_pqc | 1415.79 | D2 | ≤ 5000 | PASS |
| attacks_tamper_auth_hmac | 936.36 | D2 | ≤ 5000 | PASS |
| attacks_tamper_auth_hybrid | 1979.23 | D2 | ≤ 5000 | PASS |
| attacks_tamper_auth_pqc | 1225.17 | D2 | ≤ 5000 | PASS |
| attacks_tamper_payload_hmac | 910.66 | D2 | ≤ 5000 | PASS |
| attacks_tamper_payload_hybrid | 1148.61 | D2 | ≤ 5000 | PASS |
| attacks_tamper_payload_pqc | 1146.71 | D2 | ≤ 5000 | PASS |
| attacks_timing_probe_hmac | 912.79 | D2 | ≤ 5000 | PASS |
| attacks_timing_probe_hybrid | 1961.81 | D2 | ≤ 5000 | PASS |
| attacks_timing_probe_pqc | 1933.90 | D2 | ≤ 5000 | PASS |
| baseline_hmac_r1 | 920.84 | D2 | ≤ 5000 | PASS |
| baseline_hybrid_r1 | 2071.65 | D2 | ≤ 5000 | PASS |
| baseline_pqc_r1 | 2068.87 | D2 | ≤ 5000 | PASS |
| bus_failure_aggregate | 0.00 | D2 | ≤ 5000 | N/A |
| bus_failure_clean | 866.56 | D2 | ≤ 5000 | PASS |
| bus_failure_heavy | 876.14 | D2 | ≤ 5000 | PASS |
| bus_failure_noisy | 907.28 | D2 | ≤ 5000 | PASS |
| deadline_relaxed | 857.97 | D2 | ≤ 5000 | PASS |
| deadline_tight | 50319.55 | D2 | ≤ 5000 | FAIL |
| keymismatch_aggregate | 0.00 | D2 | ≤ 5000 | N/A |
| keymismatch_mismatch | 0.00 | D2 | ≤ 5000 | N/A |
| keymismatch_shared | 866.84 | D2 | ≤ 5000 | PASS |
| mixed_bus_can | 1202.77 | D2 | ≤ 5000 | PASS |
| mixed_bus_eth | 2074.92 | D2 | ≤ 5000 | PASS |
| multi_ecu_aggregate | 0.00 | D2 | ≤ 5000 | N/A |
| multi_ecu_rx0 | 921.83 | D2 | ≤ 5000 | PASS |
| multi_ecu_rx1 | 902.42 | D2 | ≤ 5000 | PASS |
| multi_ecu_rx2 | 896.95 | D2 | ≤ 5000 | PASS |
| multi_ecu_tx | 0.00 | D2 | ≤ 5000 | N/A |
| persistence_aggregate | 0.00 | D2 | ≤ 5000 | N/A |
| persistence_no_nvm | 992.12 | D2 | ≤ 5000 | PASS |
| persistence_with_nvm | 860.87 | D2 | ≤ 5000 | PASS |
| rekey_r1 | 104.78 | D2 | ≤ 5000 | PASS |
| rollover_hmac_r1 | 0.00 | D2 | ≤ 5000 | N/A |
| rollover_pqc_r1 | 0.00 | D2 | ≤ 5000 | N/A |
| tput_hmac_canfd_r1 | 915.45 | D2 | ≤ 5000 | PASS |
| tput_pqc_eth1000_r1 | 1096.26 | D2 | ≤ 5000 | PASS |
| tput_pqc_eth100_r1 | 1214.36 | D2 | ≤ 5000 | PASS |
