...
|----------|--------------|----------------|-------------|------|
| attacks_aggregate_hmac | 2477.47 | D2 | ≤ 5000 | PASS |
| attacks_aggregate_hybrid | 3313.19 | D2 | ≤ 5000 | PASS |
| attacks_aggregate_pqc | 3252.90 | D2 | ≤ 5000 | PASS |
| attacks_downgrade_hmac_hmac | 2350.90 | D2 | ≤ 5000 | PASS |
| attacks_downgrade_hmac_hybrid | 2761.87 | D2 | ≤ 5000 | PASS |
| attacks_downgrade_hmac_pqc | 3227.44 | D2 | ≤ 5000 | PASS |
| attacks_freshness_rollback_hmac | 2594.88 | D2 | ≤ 5000 | PASS |
| attacks_freshness_rollback_hybrid | 2568.57 | D2 | ≤ 5000 | PASS |
| attacks_freshness_rollback_pqc | 3226.86 | D2 | ≤ 5000 | PASS |
| attacks_mitm_key_confuse_hmac | 2421.61 | D2 | ≤ 5000 | PASS |
| attacks_mitm_key_confuse_hybrid | 3325.78 | D2 | ≤ 5000 | PASS |
| attacks_mitm_key_confuse_pqc | 3260.22 | D2 | ≤ 5000 | PASS |
| attacks_replay_hmac | 2472.66 | D2 | ≤ 5000 | PASS |
| attacks_replay_hybrid | 2657.00 | D2 | ≤ 5000 | PASS |
| attacks_replay_pqc | 3252.90 | D2 | ≤ 5000 | PASS |
| attacks_sig_fuzz_hmac | 2475.97 | D2 | ≤ 5000 | PASS |
| attacks_sig_fuzz_hybrid | 3371.64 | D2 | ≤ 5000 | PASS |
| attacks_sig_fuzz_pqc | 2899.68 | D2 | ≤ 5000 | PASS |
| attacks_tamper_auth_hmac | 2401.93 | D2 | ≤ 5000 | PASS |
| attacks_tamper_auth_hybrid | 3271.93 | D2 | ≤ 5000 | PASS |
| attacks_tamper_auth_pqc | 2415.90 | D2 | ≤ 5000 | PASS |
| attacks_tamper_payload_hmac | 2451.41 | D2 | ≤ 5000 | PASS |
| attacks_tamper_payload_hybrid | 3270.46 | D2 | ≤ 5000 | PASS |
| attacks_tamper_payload_pqc | 2570.12 | D2 | ≤ 5000 | PASS |
| baseline_hmac_r1 | 2469.65 | D2 | ≤ 5000 | PASS |
| baseline_hybrid_r1 | 3348.53 | D2 | ≤ 5000 | PASS |
| baseline_pqc_r1 | 3356.86 | D2 | ≤ 5000 | PASS |
| bus_failure_aggregate | 0.00 | D2 | ≤ 5000 | N/A |
| bus_failure_clean | 2444.08 | D2 | ≤ 5000 | PASS |
| bus_failure_heavy | 2446.35 | D2 | ≤ 5000 | PASS |
| bus_failure_noisy | 2376.84 | D2 | ≤ 5000 | PASS |
| deadline_relaxed | 3199.87 | D2 | ≤ 5000 | PASS |
| deadline_tight | 51361.46 | D2 | ≤ 5000 | FAIL |
| mixed_bus_can | 3265.51 | D2 | ≤ 5000 | PASS |
| mixed_bus_eth | 4381.45 | D2 | ≤ 5000 | PASS |
| multi_ecu_aggregate | 0.00 | D2 | ≤ 5000 | N/A |
| multi_ecu_rx0 | 2449.34 | D2 | ≤ 5000 | PASS |
| multi_ecu_rx1 | 2387.08 | D2 | ≤ 5000 | PASS |
| multi_ecu_rx2 | 2405.77 | D2 | ≤ 5000 | PASS |
| multi_ecu_tx | 0.00 | D2 | ≤ 5000 | N/A |
| persistence_aggregate | 0.00 | D2 | ≤ 5000 | N/A |
| persistence_no_nvm | 2554.08 | D2 | ≤ 5000 | PASS |
| persistence_with_nvm | 2434.17 | D2 | ≤ 5000 | PASS |
| rekey_r1 | 102.22 | D2 | ≤ 5000 | PASS |
| tput_hmac_canfd_r1 | 2482.59 | D2 | ≤ 5000 | PASS |
| tput_pqc_eth1000_r1 | 2222.95 | D2 | ≤ 5000 | PASS |
| tput_pqc_eth100_r1 | 2597.67 | D2 | ≤ 5000 | PASS |
...
|----------|------------------------|----------------------------|--------------------|------|
| attacks_aggregate_hmac | 403 | 157 | 71.96 | FAIL |
| attacks_aggregate_hybrid | 556 | 4 | 99.29 | PASS |
| attacks_aggregate_pqc | 557 | 3 | 99.46 | PASS |
| attacks_downgrade_hmac_hmac | 0 | 80 | 0.00 | FAIL |
| attacks_downgrade_hmac_hybrid | 80 | 0 | 100.00 | PASS |
| attacks_downgrade_hmac_pqc | 80 | 0 | 100.00 | PASS |
| attacks_freshness_rollback_hmac | 80 | 0 | 100.00 | PASS |
| attacks_freshness_rollback_hybrid | 80 | 0 | 100.00 | PASS |
| attacks_freshness_rollback_pqc | 80 | 0 | 100.00 | PASS |
| attacks_mitm_key_confuse_hmac | 80 | 0 | 100.00 | PASS |
| attacks_mitm_key_confuse_hybrid | 80 | 0 | 100.00 | PASS |
| attacks_mitm_key_confuse_pqc | 80 | 0 | 100.00 | PASS |
| attacks_replay_hmac | 3 | 77 | 3.75 | FAIL |
| attacks_replay_hybrid | 76 | 4 | 95.00 | PASS |
| attacks_replay_pqc | 77 | 3 | 96.25 | PASS |
| attacks_sig_fuzz_hmac | 80 | 0 | 100.00 | PASS |
| attacks_sig_fuzz_hybrid | 80 | 0 | 100.00 | PASS |
| attacks_sig_fuzz_pqc | 80 | 0 | 100.00 | PASS |
| attacks_tamper_auth_hmac | 80 | 0 | 100.00 | PASS |
| attacks_tamper_auth_hybrid | 80 | 0 | 100.00 | PASS |
| attacks_tamper_auth_pqc | 80 | 0 | 100.00 | PASS |
| attacks_tamper_payload_hmac | 80 | 0 | 100.00 | PASS |
| attacks_tamper_payload_hybrid | 80 | 0 | 100.00 | PASS |
| attacks_tamper_payload_pqc | 80 | 0 | 100.00 | PASS |
...
| persistence_aggregate | 40 | 40 | — | FAIL |
| persistence_no_nvm | 0 | 40 | — | PASS |
| persistence_with_nvm | 40 | 0 | — | FAIL |
| rekey_r1 | 0 | 0 | — | PASS |
